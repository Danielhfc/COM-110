...
/* abre o arquivo exercicioArquivo no modo leitura e gravação e atribui o endereço do arquivo ao ponteiro
arq. O modo w+ abre o arquivo no inicio substituindo o conteúdo do arquivo.*/
...
printf("\nDigite a N2:");
scanf("%f", &nota2);
fprintf(arq, "%d %.2f %.2f\n", mat, nota1, nota2); // grava os valores das variáveis nota1 e nota2 no
//arquivo apontado por arq
